 ...
 */
public class SaveGameOld {

    private static final String TAG = "SAVE_GAME";
     ...
     */
    public SaveGameOld(String json) {
     ...
     */
    public SaveGameOld(SharedPreferences sp, String key) {
     ...
     */
    public SaveGameOld unionWith(SaveGameOld other) {
        SaveGameOld result = clone();
     ...
     */
    public SaveGameOld clone() {
        SaveGameOld result = new SaveGameOld();
        for (String levelName : mLevelStars.keySet()) {
